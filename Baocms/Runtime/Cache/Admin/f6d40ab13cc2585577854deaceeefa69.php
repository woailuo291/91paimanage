    ...
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <form method="post" action="<?php echo U('usercard/index');?>">
                ...
                <div id="top_title" style="width:50%; height:auto; font-size: 1.3rem;">当前总提现:<?php echo ($dai_tixian / 100); ?>元</div>
        ...
        <div class="tableBox">
            <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                        ...
                        <td><?php echo ($var['money_yu'] / 100); ?></td>
                    ...
                    <td>
                    <?php if($var["status"] == 0): ?><!-- <?php echo BA('usercash/zfbpass',array("cash_id"=>$var["ID"],"zfb_name"=>$var["user_name"] ,"zfb"=>$var["zfb_num"],"money"=>$var["money"],"status" => 1),'通过','act','remberBtn');?>-->
                        <?php echo BA('usercash/zfbpass',array("cash_id"=>$var["ID"],"status" => 1),'通过','act','remberBtn');?>
                        <?php echo BA('usercash/inbalcklist',array("cash_id"=>$var["ID"], "status" => 1),'拉倒黑名单','act','remberBtn');?>
                        <?php echo BA('usercash/editbankinfo',array("user_id"=>$var["user_id"]),'编辑银行信息','','remberBtn');?>
