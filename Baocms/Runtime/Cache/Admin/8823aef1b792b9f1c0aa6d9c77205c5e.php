...
<div class="mainBt">
    <ul>
        <li class="li1">设置</li>
        <li class="li2">盈利统计</li>
        <li class="li2 li3">今日盈利</li>
    </ul>
</div>
<div class="main-jsgl main-sc">
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <form method="post" action="<?php echo U('money/profit');?>">
            ...
            <div class="tableBox">
                <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                    ...
                    <tr>
                        ...
                        <td>扫雷</td>
                        <td>
                            <p>抢包：<?php echo ($saolei_miansi); ?>元</p>
                            <p>返佣：<?php echo ($saolei_fenyong); ?>元</p>
                            <p>盈利：<?php echo ($saolei_yingli); ?>元</p>
                        </td>

                        <td>

                            <!--<?php echo BA('money/profitinfo',array("sta"=>$todaytime,"end"=>$today_end,"game"=>"saolei"),'查看明细','','remberBtn');?>-->
                    ...
                    <tr>
                        ...
                        <td>接龙</td>
                        <td>
                            <p>抢包：<?php echo ($jielong_miansi); ?>元</p>
                            <p>返佣：<?php echo ($jielong_fenyong); ?>元</p>
                            <p>盈利：<?php echo ($jielong_yingli); ?>元</p>

                        </td>

                        <td>

                            <!--<?php echo BA('money/profitinfo',array("sta"=>$todaytime,"end"=>$today_end,"game"=>"jielong"),'查看明细','','remberBtn');?>-->
                            <!--<?php echo BA('usercash/audit',array("cash_id"=>$var["cash_id"], "status" => 2),'拒绝','load','remberBtn');?> -->
                            <!--<a class="remberBtn jujue"  href="javascript:void(0);" rel="<?php echo ($var["user_id"]); ?>" style=" background-color: #de5b23;">拒绝</a>-->
