            ...
            <div class="right">
                <form class="search_form" method="post" action="<?php echo U('user/index');?>">
                    <div class="seleHidden" id="seleHidden">
                        <label>
                            <span>会员ID</span>
                            <input type="text" name="user_id" value="<?php echo ($user_id); ?>" class="inptText" />
                        </label>
            ...
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                    ...
                    <td class="w150">
                        ...
                        <?php echo BA('user/vipinfo',array("user_id"=>$var["user_id"]),'查看明细','load','remberBtn_small',800,800);?>
                        <?php echo BA('user/vipshang',array("user_id"=>$var["user_id"]),'查看上级','load','remberBtn_small',700,600);?>
                        <?php echo BA('user/vipxia',array("user_id"=>$var["user_id"]),'查看下级','load','remberBtn_small',700,600);?>
