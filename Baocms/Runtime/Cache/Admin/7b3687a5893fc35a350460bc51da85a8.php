...
<div class="main-jsgl main-sc">
    <div class="jsglNr">
        ...
        <!--*******************-->
        <form method="post" action="<?php echo U('usercash/edit');?>">
        ...
        <div class="tableBox">
            <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                        ...
                        <td>
                            <p><?php echo ($var["user_name"]); ?></p>

                        </td>
                        <td><?php echo ($var['bank_num']); ?></td>
                        <td><?php echo ($var['bank_info']); ?></td>


                        <td>

                                <?php echo BA('usercash/edit',array("user_id"=>$var["user_id"]),'编辑','','remberBtn');?>
