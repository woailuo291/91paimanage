...
<div class="listBox clfx">
    ...
    <div class="menuManage">
        ...
        <form target="baocms_frm" action="<?php echo U('user/notice',array('user_id'=>$vars));?>" method="post">
                ...
                <div class="tableBox">
                    ...
                    <table  bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;" >
                        ...
                        <tr>
                            ...
                            <td class="rgTdBt"><input type="text" name="data[title]" value="" class="scAddTextName w200" />
                        ...
                        <tr>
                            ...
                            <td class="rgTdBt"><input type="text" name="data[content]" value="" class="scAddTextName w200" />
