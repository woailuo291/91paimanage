...
<div class="mainBt">
    <ul>
        <li class="li1">设置</li>
        <li class="li2">提现统计</li>
        <li class="li2 li3">今日提现</li>
    </ul>
</div>
<div class="main-jsgl main-sc">
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <form method="post" action="<?php echo U('money/putmoney');?>">
                ...
                <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo BA('money/putinfo',array("sta"=>$todaytime,"end"=>$today_end),'查看明细','','remberBtn');?>
