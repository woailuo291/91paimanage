...
<div class="mainBt">
    <ul>
        <li class="li1">设置</li>
        <li class="li2">返佣统计</li>
        <li class="li2 li3">今日返佣</li>
    </ul>
</div>
<div class="main-jsgl main-sc">
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <form method="post" action="<?php echo U('money/maid');?>">
            ...
            <div class="tableBox">
                <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                    ...
                    <tr>
                        ...
                        <td>扫雷</td>
                        <td>
                            <p><?php echo ($saolei_liushui); ?>元</p>

                        </td>

                        <td>

                            <?php echo BA('money/maidinfo',array("sta"=>$todaytime,"end"=>$today_end,"game"=>"saolei"),'查看明细','','remberBtn');?>
                    ...
                    <tr>
                        ...
                        <td>接龙</td>
                        <td>
                            <p><?php echo ($jielong_liushui); ?>元</p>

                        </td>

                        <td>

                            <?php echo BA('money/maidinfo',array("sta"=>$todaytime,"end"=>$today_end,"game"=>"jielong"),'查看明细','','remberBtn');?>
                            <!--<?php echo BA('usercash/audit',array("cash_id"=>$var["cash_id"], "status" => 2),'拒绝','load','remberBtn');?> -->
                            <!--<a class="remberBtn jujue"  href="javascript:void(0);" rel="<?php echo ($var["user_id"]); ?>" style=" background-color: #de5b23;">拒绝</a>-->
